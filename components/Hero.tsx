...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      ...
      dark:bg-grid-white/[0.05] bg-grid-black/[0.3] absolute top-0 left-0 flex items-center justify-center">
    ...
    <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
           ...
           text-center text-blue-100 max-w-80'>Dynamic Web Wonder with Next.js</h2> 
